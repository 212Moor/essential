        ...
        ({ item, key, props: style }) =>
          item && (
            <animated.div key={key} style={style}>
              <Wrapper>
                {/* --- DEBUT LOGO SEAZONS RP --- */}
                <div style={{ position: 'absolute', top: '40px', left: '60px', pointerEvents: 'none' }}>
                  <h1 style={{ color: 'white', margin: 0, fontSize: '2.5rem', fontFamily: 'Impact, sans-serif', textShadow: '2px 2px 10px rgba(0,0,0,0.8)', letterSpacing: '2px' }}>
                    SEAZONS <span style={{ color: '#0ea5e9' }}>RP</span>
                  </h1>
                  <span style={{ background: 'rgba(14, 165, 233, 0.2)', color: '#38bdf8', padding: '6px 12px', borderRadius: '20px', fontSize: '0.85rem', textTransform: 'uppercase', fontWeight: 'bold', border: '1px solid rgba(14, 165, 233, 0.4)', letterSpacing: '1px' }}>
                    Vespucci Summer
                  </span>
                </div>
                {/* --- FIN LOGO SEAZONS RP --- */}
                ...
                {/* --- ON RE-ACTIVE LES CLICS POUR LES BOUTONS CAMERA ICI --- */}
